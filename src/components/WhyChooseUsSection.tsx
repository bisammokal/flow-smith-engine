  ...
  return (
    <section className="py-16 sm:py-20 md:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-10 sm:mb-12 md:mb-16 px-4">
          Why Choose Us
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 md:mb-12">
          {whyChooseUs.map((item, index) => {
            ...
            return (
              <Card
                key={index}
                className="w-full h-full p-4 sm:p-6 flex items-start gap-3 sm:gap-4 hover:shadow-glow hover:scale-[1.02] active:scale-[0.98] transition-all duration-300"
              >
                ...
                <p className="text-sm sm:text-base text-foreground font-medium pt-1 sm:pt-2 relative z-10 leading-relaxed">
                  {item.text}
                </p>
              </Card>
            );
        ...
        <div className="text-center px-4">
          <Button
            ...
            className="w-full sm:w-auto px-8 py-4 sm:py-5 text-base sm:text-lg"
          >
